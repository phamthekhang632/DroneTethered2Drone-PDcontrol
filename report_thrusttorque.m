...
hold on;
plot(time, mothership_positions_x, '--k', 'LineWidth', 2, 'DisplayName', 'X desired (mothership)');
...
hold on;
plot(time, minion_theta_desired_record/pi*180, '--k', 'LineWidth', 2, 'DisplayName', 'Pitch Desired');
