...
%     plot(target_position(1), target_position(2), 'rx', 'MarkerSize', 10, 'LineWidth', 2, 'DisplayName', 'Initial Target');
...
plot(time, minion_positions_x, 'Color', [194/255, 126/255, 0], 'LineWidth', 2, 'DisplayName', 'Minion');
hold on;
plot(time, mothership_positions_x, '--k', 'LineWidth', 2, 'DisplayName', 'Mothership');
% title('X position of Minion and Mothership over Time');
xlabel('Time (s)');
ylabel('Position (m)');
legend;
grid on;
