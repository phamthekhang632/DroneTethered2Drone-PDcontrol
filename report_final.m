...
for t = 1:length(time)
    ...
    frames_to_average = round(3 / dt); % Number of frames in the last 2 seconds
...
% plot(time, minion_positions_x, 'Color', [194/255, 126/255, 0], 'LineWidth', 2, 'DisplayName', 'X position');
plot(time, minion_positions_x, 'Color', 'b', 'LineWidth', 2, 'DisplayName', 'X position');
hold on;
plot(time, mothership_positions_x, '--k', 'LineWidth', 2, 'DisplayName', 'X desired');
xlabel('Time (s)');
ylabel('Position (m)');
grid on;
legend();
...
figure('Position', [100, 600, 800, 400]); % [left, bottom, width, height]
% plot(time, minion_theta_record/pi*180, 'Color', [194/255, 126/255, 0], 'LineWidth', 2, 'DisplayName', 'Pitch');
plot(time(4:end), minion_theta_record(4:end)/pi*180, 'Color', 'b', 'LineWidth', 2, 'DisplayName', 'Pitch');
hold on;
plot(time(4:end), minion_theta_desired_record(4:end)/pi*180, '--k', 'LineWidth', 2, 'DisplayName', 'Pitch Desired');
